...
public final class editpro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Edit Product Details</title>\n");
      ...
      out.write("\n");
      out.write("                <form name=\"Form1\" action=\"editpro.jsp\" method=\"POST\">\n");
      out.write("\n");
      out.write("                    ");
 ...
 while (rs.next()) {
      ...
      out.write("                                    <button style=\"width: 100%;\" type=\"submit\" name=\"btnupdate\" class=\"btn btn-success\">UPDATE PRODUCT</button>\n");
      out.write("                                </div>\n");
      out.write("                                     ");
}
      out.write("\n");
 ...
 try {
        ...
        String query = "UPDATE product SET pro_name='" + pro_name + "',category='" + category + "',qty='" + qty + "',p_price='" + p_price + "',s_price='" + s_price + "',manu_date='" + manu_date + "',exp_date='" + exp_date + "' WHERE pro_id= '" + pro_id + "'";
