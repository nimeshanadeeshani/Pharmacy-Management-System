    ...
    <section class="">
        <div class="container">
            <div class="col-md-12">
                ...
                <form name="Form1" action="editpro.jsp" method="POST">
            ...
            <div class="col-md-6">
                <img style="margin-top: 30px;" class="img-responsive addbookimg" src="images/medi1.jpg">
            </div>
            <div class="col-md-6">
                        ...
                        <form method="post" enctype="multipart/form-data" role="form">
                            <div class="col-md-12 offset_0">
                                ...
                                <div class="col-md-12 offset_0 offset_1">
                                    <button style="width: 100%;" type="submit" name="btnupdate" class="btn btn-success">UPDATE PRODUCT</button>
                                </div>
                                     <%}%>
