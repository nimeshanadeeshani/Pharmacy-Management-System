...
<html>
    ...
    <h1 style="color:brown; font-family:verdana; font-size:50px; text-align:center;">Admin Page</h1>
  
</head>
 <body>
     <% if(session.getAttribute("uid") != null){%>
      <h1 style="text-align:center; color:blue;">Hi <%String test=  session.getAttribute("uid").toString(); out.println(test);}%>!</h1> 
      
         <h2 style="text-align:right"><a href="add_admin.jsp">Add New Admin</a></h2>
          <img src="images/man.jpg" alt="" style="align:center;"/> 
